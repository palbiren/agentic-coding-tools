...
- [x] 1.1 Define acceptance criteria for plan-feature universal artifact generation
...
- [x] 1.2 Update plan-feature SKILL.md — remove tier gates on Steps 7-8
...
- [x] 1.3 Define acceptance criteria for parallel-review-implementation whole-branch fallback
...
- [x] 1.4 Update parallel-review-implementation SKILL.md — add whole-branch fallback
...
- [x] 1.5 Define acceptance criteria for implement-feature contract consumption at all tiers
...
- [x] 1.6 Update implement-feature SKILL.md — always consume contracts
...
- [x] 2.1 Update merge-pull-requests SKILL.md — document review resilience
...
- [x] 2.2 Update CLAUDE.md tier table
...
- [x] 3.2 Run skills/install.sh to sync runtime copies

...
**Database:**
- `agent-coordinator/database/migrations/020_merge_train_indexes.sql` (new) — GIN + BTREE expression indexes on `metadata->'merge_queue'` sub-document (task 5.7)
